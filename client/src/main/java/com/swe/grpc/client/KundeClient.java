...
public class KundeClient {
    public static void main(String[] args) {
        ...
        try {
                ...
                System.out.println("Error fetching customers. Please check your database.");
        }
        ...
        try {
                ...
                System.out.println("Error fetching customer by ID. Please check your ID input and make sure this id is set.");
        }
        ...
        System.out.println(createResponse.getMessage());
                ...
                System.out.println("Error creating customer. Please check your input.");
        }
        ...
        try {
                ...
                System.out.println("Error deleting customer. Please check for existing customer.");
        }
